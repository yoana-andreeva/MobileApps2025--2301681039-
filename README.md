...
| Dashboard | Задачи | Предмети | Календар |
|---|---|---|---|
| ![Dashboard](docs/images/dashboard.png) | ![Tasks](docs/images/tasks.png) | ![Subjects](docs/images/subjects.png) | ![Calendar](docs/images/calendar.png) |
...
**Йоана Андреева** — Факултетен номер: 2301681039
